...
ui <- fluidPage(
  ...
  # Application title
  titlePanel("Inferencial Statistics"),
  #h2(tags$a(href = "https://www.antoinesoetewey.com/", "Antoine Soetewey")),
  ...
  sidebarLayout(
    sidebarPanel(
      selectInput(
        inputId = "inference",
        label = "Inference for:",
        choices = c("one mean", "two means", "two means (paired samples)", 
                    "one proportion", "two proportions", "one variance", "two variances"),
        multiple = FALSE,
        selected = "one mean"
      ),
      hr(),
      ...
      HTML('<a rel="license" href="http://creativecommons.org/licenses/by/2.0/be/" 
      target="_blank"><img alt="Licence Creative Commons" style="border-width:0"
        ...
        This work is made available under the terms of the <a rel="license"
        href="http://creativecommons.org/licenses/by/2.0/be/" target="_blank">
        Creative Commons Attribution 2.0 Belgium license</a>.
        Source code available on 
           <a href="https://github.com/ArashArd/Inferencial-Stat" target="_blank">GitHub</a>.')
    ),
  ...
  output$results_onemean <- renderUI({
    ...
    if (anyNA(dat) | length(dat) < 2) {
      ...
      withMathJax(
        ...
        br(),
        paste0("4. Conclusion : ", ifelse(test$p.value < input$alpha, "Reject \\(H_0\\)", "Do not have enough evidence to reject \\(H_0\\)")),
        br(),
        br(),
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test$p.value < input$alpha, "we reject the null hypothesis that the true mean is ", "we do not have enough evidence to reject the null hypothesis that the true mean is "), test$null.value, " \\((p\\)-value ", ifelse(test$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test$p.value, 3))), ")", ".")
      )
      ...
      withMathJax(
        ...
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test$p.value < input$alpha, "we reject the null hypothesis that the true mean is ", "we do not have enough evidence to reject the null hypothesis that the true mean is "), input$h0, " \\((p\\)-value ", ifelse(test$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test$p.value, 3))), ")", ".")
      )
    } else {
      print("loading...")
    }
  ...
  output$results_twomeanspaired <- renderUI({
    ...
    if (anyNA(dat1) | length(dat1) < 2 | anyNA(dat2) | length(dat2) < 2) {
      ...
      withMathJax(
        ...
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test$p.value < input$alpha, "we reject the null hypothesis that the true mean of the difference is equal to ", "we do not have enough evidence to reject the null hypothesis that the true mean of the difference is equal to "), test$null.value, " \\((p\\)-value ", ifelse(test$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test$p.value, 3))), ")", ".")
      )
  ...
  output$results_twomeans <- renderUI({
    ...
    if (anyNA(dat1) | length(dat1) < 2 | anyNA(dat2) | length(dat2) < 2) {
      ...
      withMathJax(
        ...
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test$p.value < input$alpha, "we reject the null hypothesis that the true difference in means is ", "we do not have enough evidence to reject the null hypothesis that the true difference in means is "), test$null.value, " \\((p\\)-value ", ifelse(test$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test$p.value, 3))), ")", ".")
      )
      ...
      withMathJax(
        ...
        paste0("4. Conclusion : ", ifelse(test$p.value < input$alpha, 
                                          "Reject \\(H_0\\)", "Do not have enough evidence to reject \\(H_0\\)")),
        br(),
        br(),
        tags$b("Interpretation"),
        br(),
  ...
  output$results_oneprop <- renderUI({
    if (input$inference == "one proportion" & input$propx_oneprop == "prop_true") {
      ...
      withMathJax(
        ...
        br(),
        paste0("4. Conclusion : ", ifelse(test2$p.value < input$alpha, "Reject \\(H_0\\)", "Do not have enough evidence to reject \\(H_0\\)")),
        br(),
        br(),
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test2$p.value < input$alpha, "we reject the null hypothesis that the true proportion is ", "we do not have enough evidence to reject the null hypothesis that the true proportion is "), test2$null.value, " \\((p\\)-value ", ifelse(test2$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test2$p.value, 3))), ")", ".")
      )
  ...
  output$results_twoprop <- renderUI({
    if (input$inference == "two proportions" & input$propx_twoprop == "prop_true" & input$pooledstderr_twoprop == FALSE) {
      ...
      withMathJax(
        ...
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test$p.value < input$alpha, "we reject the null hypothesis that the true difference in proportions is ", "we do not have enough evidence to reject the null hypothesis that the true difference in proportions is "), test$null.value, " \\((p\\)-value ", ifelse(test$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test$p.value, 3))), ")", ".")
      )
  ...
  output$results_onevar <- renderUI({
    ...
    if (anyNA(dat) | length(dat) < 2) {
      ...
      withMathJax(
        ...
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test$p.value < input$alpha, "we reject the null hypothesis that the true variance is equal to ", "we do not have enough evidence to reject the null hypothesis that the true variance is equal to "), test$null.value, " \\((p\\)-value ", ifelse(test$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test$p.value, 3))), ")", ".")
      )
    } else {
      print("loading...")
    }
  ...
  output$results_twovar <- renderUI({
    ...
    if (anyNA(dat1) | length(dat1) < 2 | anyNA(dat2) | length(dat2) < 2) {
      ...
      withMathJax(
        ...
        tags$b("Interpretation"),
        br(),
        paste0("At the ", input$alpha * 100, "% significance level, ", ifelse(test$p.value < input$alpha, "we reject the null hypothesis that the true ratio of variances is equal to ", "we do not have enough evidence to reject the null hypothesis that the true ratio of variances is equal to "), test$null.value, " \\((p\\)-value ", ifelse(test$p.value < 0.001, "< 0.001", paste0("\\(=\\) ", round(test$p.value, 3))), ")", ".")
      )
    } else {
      print("loading...")
    }
